 ...
 * @category	classes
 * @author		MilkZoft Developer Team
 * @link		http://www.zanphp.com/documentation/en/classes/pgsql_db_class
 */
class ZP_PgSQL_Db extends ZP_Load {
	...
	public function connect() {
		if(self::$connection === NULL) {
			self::$connection = pgsql_connect(_dbHost, _dbUser, _dbPwd, _dbName);
		}
	...
	public function insert($table, $fields, $values) {
		...
		return (pgsql_query($query)) ? TRUE : FALSE;
	}
	...
	public function fetch() {			
		return (!$this->query) ? FALSE : pgsql_fetch_assoc($this->query);	
	}
	...
	public function rows() {
		return (!$this->query) ? FALSE : (int) pgsql_num_rows($this->query);	
	}
	...
	public function insertID() {
		return pgsql_insert_id(self::$connection);
	}
	...
	public function free() {
	 	return (!$this->query) ? FALSE : pgsql_free_result($this->query);
	}
	...
	public function close() {
		return (!self::$connection) ? FALSE : pgsql_close(self::$connection); 	
	}	
}